...
def generate_launch_description():
    ...
    pose_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["test_pose_controller", "--controller-manager", "/controller_manager"],
        output='screen'
    )
    ...
    imu_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["test_imu_controller", "--controller-manager", "/controller_manager"],
        output='screen'
    )
